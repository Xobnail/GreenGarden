...
namespace GreenGarden.Database.Migrations
{
    ...
    [Migration("20250526083519_AddOrderAndCustomer")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GreenGarden.Domain.Entities.Customer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("GreenGarden.Domain.Entities.LineItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("GreenGarden.Domain.Entities.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("GreenGarden.Domain.Entities.LineItem", b =>
                {
                    b.HasOne("GreenGarden.Domain.Entities.Plant", "ChosenPlant")
                        .WithMany("LineItems")
                        .HasForeignKey("ChosenPlantId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("GreenGarden.Domain.Entities.Order", "Order")
                        .WithMany("LineItems")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ChosenPlant");
            ...
            modelBuilder.Entity("GreenGarden.Domain.Entities.Order", b =>
                {
                    b.HasOne("GreenGarden.Domain.Entities.Customer", "Customer")
                        .WithMany("Orders")
